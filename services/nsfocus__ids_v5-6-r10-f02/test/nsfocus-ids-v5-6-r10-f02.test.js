...
test('allows a zebra-styled empty-state row that is not shaped like an event', async () => {
  withFetch(async () => fakeResponse(200, '<table id="mytable"><tr class="even"><td colspan="7">暂无数据</td></tr></table>'));
